...
int main()
{
    ...
    for(int k =0 ; k <3; ++k){
        ...
        //String filename2 = string("_gk_")+to_string(filtersize)+string(".txt");
        cout << filename << endl;
        oneDoutput(filename,oneDconvOutput);
        //oneDoutput(filename2,gk_1d);
    }
    ...
    for(int k =0 ; k <3; ++k){
        ...
        //Matrix gk_norm = twoDnormalize(gk_2d);
        Mat convimg = matrix2img(normalized);
        //Mat gkimg = matrix2img(gk_norm);
        String filename_img = "lenna_" + string("gk_") + to_string(filtersize)+string(".png");
        //String filename_img2 = string("gk_") + to_string(filtersize)+string(".png");
        cout << filename_img << endl;
        imwrite(filename_img,convimg);
        //imwrite(filename_img2,gkimg);
